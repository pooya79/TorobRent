...
LISTING_INQUIRY_REPEATED_CONTENT_DAILY_LIMIT = env.int(
    "LISTING_INQUIRY_REPEATED_CONTENT_DAILY_LIMIT", default=3
)
STORAGES = {
...
CELERY_BEAT_SCHEDULE = {
    "cleanup-source-snapshots": {
        "task": "apps.source_proposals.tasks.cleanup_source_snapshots",
        "schedule": 3600.0,
    },
