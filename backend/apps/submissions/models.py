...
class SubmissionImage(models.Model):
    ...
    raw_content_sha256 = models.CharField(max_length=64, blank=True)
    normalized_pixel_sha256 = models.CharField(max_length=64, blank=True)
    perceptual_dhash = models.CharField(max_length=16, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
