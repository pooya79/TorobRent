...
const dataFields = [
  ...
  [
    ...
    "description",
    "توافق‌پذیری و امکان تبدیل رهن و اجاره را جدا توضیح دهید. از مبلغ صفر یا نبود مبلغ برای بیان این شرایط استفاده نکنید؛ نمایش نهایی به بررسی منبع بستگی دارد.",
  ],
  [
    "تصاویر و نشانی",
    "image · url",
        ...
        <div className="min-w-0 space-y-6">
          ...
          >
            ...
            <details className="rounded-xl border p-4 sm:p-5">
              ...
              <p className="mt-4 font-medium">
                رهن و اجاره ماهانه را جدا و با واحد پول روشن بنویسید.
              </p>
              <p className="text-muted-foreground text-sm">
                مبلغ بدون واحد یا یک عدد مشترک برای رهن و اجاره مبهم است. در
            ...
            <div>
              ...
              <Checklist
                items={[
                  ...
                  "متراژ، اتاق خواب، محله، رهن و اجاره را با برچسب واضح و به صورت متن بنویسید؛ قرار دادن همه اطلاعات داخل تصویر کافی نیست.",
          ...
          >
            <ol className="marker:text-primary list-decimal space-y-4 ps-5 marker:font-semibold">
              ...
              <li>
                <strong>شرایط اجاره:</strong> رهن و اجاره ماهانه را جداگانه و به
                تومان وارد کنید. مبلغ صفر را فقط زمانی بزنید که واقعاً آن بخش از
                مبلغ صفر است.
              </li>
              <li>
          ...
          >
            <Checklist
              items={[
                "محله و نوع ملک را انتخاب کنید، سپس فیلترهای رهن، اجاره و مشخصات را متناسب با نیاز خود تنظیم کنید.",
                "رهن و اجاره ماهانه یک آگهی را با هم مقایسه کنید؛ کمترین رهن یک منبع را با کمترین اجاره منبع دیگر ترکیب نکنید.",
